...
data class UnavailableSlotsResponse(
    val success: Boolean,
    val data: List<UnavailableSlot>
)
...
interface BookingApi {
    ...
    @GET("Apointment/UnavailableSlots")
    suspend fun getUnavailableSlots(
        @Query("artistId") artistId: Int,
        @Query("startDate") startDate: String,
        @Query("endDate") endDate: String
    ): Response<UnavailableSlotsResponse>
